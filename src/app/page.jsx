...
import { NfcIcon as RfidIcon, CreditCardIcon, CarIcon, ComponentIcon as ChipIcon } from "lucide-react"
    ...
    (<div className="min-h-screen bg-gradient-to-b from-blue-100 to-white">
      ...
      <main className="container mx-auto py-16">
        <section className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 mb-8">The Future of Automated Tolling Systems</p>
